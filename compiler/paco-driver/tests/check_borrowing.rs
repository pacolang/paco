...
fn read_then_int(read: &Box, value: i64) {}

fn take_to_int(value: Box) -> i64 {
    1
}
...
struct Box {
    ...
    fn read_with(&self, other: &mut Box) -> i64 {
        self.value
    }
}
...
fn main() {
    let mut box: Box = Box { value: 1 };
    let value: i64 = box.read_with(&mut box);
    print(value)
}
"#;
...
struct Box {
    ...
    fn update_with(&mut self, other: &Box) {}
}
...
struct Box {
    ...
    fn update_with(&mut self, other: &mut Box) {}
}
...
struct Box {
    ...
    fn read_consume(&self, other: Box) -> i64 {
        self.value
    }
}
...
fn main() {
    let box: Box = Box { value: 1 };
    let value: i64 = box.read_consume(box);
    print(value)
}
"#;
...
struct Box {
    ...
    fn read_int(&self, value: i64) -> i64 {
        self.value
    }
}
...
fn main() {
    let box: Box = Box { value: 1 };
    let value: i64 = box.read_int(take_to_int(box));
    print(value)
}
"#;
...
struct Box {
    ...
    fn update_consume(&mut self, other: Box) {}
}
...
fn main() {
    let mut box: Box = Box { value: 1 };
    let shared: &Box = &box;
    let field: &mut i64 = &mut box.value;
    print(shared.value);
    print(field)
}
"#;
...
fn main() {
    let box: Box = Box { value: 1 };
    let mut shared: &Box = &box;
    let field: &mut i64 = &mut shared.value;
    print(field)
}
"#;
